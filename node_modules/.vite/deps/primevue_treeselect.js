import {
  script as script4
} from "./chunk-P7P5VGUP.js";
import "./chunk-Y2NCND66.js";
import "./chunk-OPJ7UE2Q.js";
import "./chunk-EQXX6LLA.js";
import {
  OverlayEventBus
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    createBaseVNode("div", mergeProps({ class: "p-treeselect-label-container" }, _ctx.ptm("labelContainer")), [
          ...
          $props.display === "comma" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.selectedNodes, (node) => {
              return openBlock(), createElementBlock("div", mergeProps({
                ...
                createBaseVNode("span", mergeProps({ class: "p-treeselect-token-label" }, _ctx.ptm("tokenLabel")), toDisplayString(node.label), 17)
              ], 16);
            }), 128)),
