...
var _hoisted_1 = ["id", "checked", "value", "aria-labelledby", "aria-label"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("div", mergeProps({
    ...
    createBaseVNode("span", mergeProps({ class: "p-hidden-accessible" }, _ctx.ptm("hiddenInputWrapper")), [
    ...
    renderSlot(_ctx.$slots, "icon", {
      ...
      $props.onIcon || $props.offIcon ? (openBlock(), createElementBlock("span", mergeProps({
        key: 0,
        class: $options.iconClass
      }, _ctx.ptm("icon")), null, 16)) : createCommentVNode("", true)
    ]),
    createBaseVNode("span", mergeProps({ class: "p-button-label" }, _ctx.ptm("label")), toDisplayString($options.label), 17)
  ], 16)), [
    [_directive_ripple]
  ]);
}
