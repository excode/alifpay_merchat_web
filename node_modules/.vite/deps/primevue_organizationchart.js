...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("table", mergeProps({ class: "p-organizationchart-table" }, _ctx.ptm("table")), [
    createBaseVNode("tbody", normalizeProps(guardReactiveProps(_ctx.ptm("body"))), [
      $props.node ? (openBlock(), createElementBlock("tr", normalizeProps(mergeProps({ key: 0 }, _ctx.ptm("row"))), [
        createBaseVNode("td", mergeProps({ colspan: $options.colspan }, _ctx.ptm("cell")), [
      ...
      createBaseVNode("tr", mergeProps({
        ...
        createBaseVNode("td", { colspan: $options.colspan }, [
          createBaseVNode("div", mergeProps({ class: "p-organizationchart-line-down" }, _ctx.ptm("lineDown")), null, 16)
        ], 8, _hoisted_2)
      ], 16),
      createBaseVNode("tr", mergeProps({
        style: $options.childStyle,
