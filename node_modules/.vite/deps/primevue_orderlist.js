...
var _hoisted_1 = ["id", "onClick", "aria-selected", "onMousedown"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({ class: $options.containerClass }, _ctx.ptm("root")), [
    createBaseVNode("div", mergeProps({ class: "p-orderlist-controls" }, _ctx.ptm("controls")), [
    ...
    createBaseVNode("div", mergeProps({ class: "p-orderlist-list-container" }, _ctx.ptm("container")), [
