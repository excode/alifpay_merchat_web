...
var _hoisted_5 = ["id"];
var _hoisted_6 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousedown", "onMousemove"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    $props.filter ? (openBlock(), createElementBlock("div", mergeProps({
      ...
      createBaseVNode("div", mergeProps({ class: "p-listbox-filter-container" }, _ctx.ptm("filterContainer")), [
