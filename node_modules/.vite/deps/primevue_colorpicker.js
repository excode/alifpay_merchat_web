...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    }, _ctx.ptm("input")), null, 16, _hoisted_1)) : createCommentVNode("", true),
    createVNode(_component_Portal, {
      ...
      default: withCtx(() => [
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            ($props.inline ? true : $data.overlayVisible) ? (openBlock(), createElementBlock("div", mergeProps({
              key: 0,
              ref: $options.pickerRef,
              class: $options.pickerClass,
              onClick: _cache[10] || (_cache[10] = (...args) => $options.onOverlayClick && $options.onOverlayClick(...args))
            }, _ctx.ptm("panel")), [
              createBaseVNode("div", mergeProps({ class: "p-colorpicker-content" }, _ctx.ptm("content")), [
                createBaseVNode("div", mergeProps({
                  ...
                  createBaseVNode("div", mergeProps({ class: "p-colorpicker-color" }, _ctx.ptm("color")), [
                    createBaseVNode("div", mergeProps({
