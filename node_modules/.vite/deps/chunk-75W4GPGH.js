...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("li", mergeProps({
    ...
    createBaseVNode("div", mergeProps({
      ...
      createBaseVNode("span", mergeProps({ class: $options.icon }, $options.getPTOptions("nodeIcon")), null, 16),
      createBaseVNode("span", mergeProps({ class: "p-treenode-label" }, $options.getPTOptions("label")), [
...
//# sourceMappingURL=chunk-75W4GPGH.js.map
