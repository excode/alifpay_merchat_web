import {
  script as script9,
  script2 as script10
} from "./chunk-XQREHWBY.js";
import {
  script as script4,
  script2 as script7,
  script3 as script8
} from "./chunk-R4RH2PJM.js";
import {
  script as script6
} from "./chunk-NMP4JKQF.js";
import {
  script as script5
} from "./chunk-WJJ7BFJF.js";
import {
  script as script3
} from "./chunk-HZUQ7TG7.js";
import {
  script as script2
} from "./chunk-JIELBEUF.js";
...
var _hoisted_1 = ["id", "onClick", "onDblclick", "onMousedown", "aria-selected"];
var _hoisted_2 = ["id", "onClick", "onDblclick", "onMousedown", "aria-selected"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({ class: $options.containerClass }, _ctx.ptm("root")), [
    ...
    createBaseVNode("div", mergeProps({ class: "p-picklist-list-wrapper p-picklist-source-wrapper" }, _ctx.ptm("sourceWrapper")), [
    ...
    createBaseVNode("div", mergeProps({ class: "p-picklist-buttons p-picklist-transfer-buttons" }, _ctx.ptm("buttons")), [
    ...
    createBaseVNode("div", mergeProps({ class: "p-picklist-list-wrapper p-picklist-target-wrapper" }, _ctx.ptm("targetWrapper")), [
