  ...
  return openBlock(), createElementBlock("div", mergeProps({ class: $options.containerClass }, _ctx.ptm("root")), [
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.value, (item, index) => {
      return openBlock(), createElementBlock("div", mergeProps({
        ...
        createBaseVNode("div", mergeProps({ class: "p-timeline-event-opposite" }, _ctx.ptm("opposite")), [
          renderSlot(_ctx.$slots, "opposite", {
            item,
            index
          })
        ], 16),
        createBaseVNode("div", mergeProps({ class: "p-timeline-event-separator" }, _ctx.ptm("separator")), [
          renderSlot(_ctx.$slots, "marker", {
            item,
            index
          }, () => [
            createBaseVNode("div", mergeProps({ class: "p-timeline-event-marker" }, _ctx.ptm("marker")), null, 16)
          ]),
          index !== $props.value.length - 1 ? renderSlot(_ctx.$slots, "connector", {
            ...
            createBaseVNode("div", mergeProps({ class: "p-timeline-event-connector" }, _ctx.ptm("connector")), null, 16)
          ]) : createCommentVNode("", true)
        ], 16),
        createBaseVNode("div", mergeProps({ class: "p-timeline-event-content" }, _ctx.ptm("content")), [
