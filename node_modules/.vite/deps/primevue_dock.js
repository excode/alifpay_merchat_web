...
var _hoisted_2 = ["id", "aria-label", "aria-disabled", "onClick", "onMouseenter"];
    ...
    createBaseVNode("ul", mergeProps({
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.model, (processedItem, index) => {
        return openBlock(), createElementBlock("li", mergeProps({
          ...
          createBaseVNode("div", mergeProps({ class: "p-menuitem-content" }, $options.getPTOptions($options.getItemId(index), "content")), [
