...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    $props.welcomeMessage ? (openBlock(), createElementBlock("div", normalizeProps(mergeProps({ key: 0 }, _ctx.ptm("welcomeMessage"))), toDisplayString($props.welcomeMessage), 17)) : createCommentVNode("", true),
    createBaseVNode("div", mergeProps({ class: "p-terminal-content" }, _ctx.ptm("content")), [
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.commands, (command, i) => {
        return openBlock(), createElementBlock("div", mergeProps({
          key: command.text + i.toString()
        }, _ctx.ptm("commands")), [
          createBaseVNode("span", mergeProps({ class: "p-terminal-prompt" }, _ctx.ptm("prompt")), toDisplayString($props.prompt), 17),
          createBaseVNode("span", mergeProps({ class: "p-terminal-command" }, _ctx.ptm("command")), toDisplayString(command.text), 17),
    ...
    createBaseVNode("div", mergeProps({ class: "p-terminal-prompt-container" }, _ctx.ptm("container")), [
      createBaseVNode("span", mergeProps({ class: "p-terminal-prompt" }, _ctx.ptm("prompt")), toDisplayString($props.prompt), 17),
