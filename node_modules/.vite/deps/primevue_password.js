import {
  script as script5
} from "./chunk-QSFCPDCN.js";
import {
  script as script4
} from "./chunk-A2H67LTU.js";
import {
  OverlayEventBus
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              renderSlot(_ctx.$slots, "content", {}, () => [
                createBaseVNode("div", mergeProps({ class: "p-password-meter" }, _ctx.ptm("meter")), [
                  createBaseVNode("div", mergeProps({
                    class: $options.strengthClass,
                    style: { width: $data.meter ? $data.meter.width : "" }
                  }, _ctx.ptm("meterLabel")), null, 16)
                ], 16),
                createBaseVNode("div", mergeProps({ class: "p-password-info" }, _ctx.ptm("info")), toDisplayString($data.infoText), 17)
              ]),
