...
const { merchantPhotoss, error, loading,totalpages,page,totalRecords} = storeToRefs(useMerchantPhotosStore())
const {  
getMerchantPhotos
...
onMounted(() => {
    getMerchantPhotos({limit:rows.value})
});
...
const newData=async(e,type)=>{
    ...
    if(type==2)  request={limit:e.rows,page:0}
     await getMerchantPhotos(request)
}
</script>
                    ...
                    <template #list="slotProps">
                        <div class="col-12">
                            <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                                <img v-if="slotProps.data.uploadedPhoto!=undefined" :src="config.serverURI+'/' + slotProps.data.uploadedPhoto" :alt="slotProps.data.name" class="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <div class="mb-3">{{ slotProps.data.titile }}</div>
                        ...
                        <div class="col-12 md:col-4">
                            <div class="card m-3 border-1 surface-border">
                                ...
                                <div class="text-center">
                                    ...
                                    <img v-if="slotProps.data.uploadedPhoto!=undefined" :src="config.serverURI+'/' + slotProps.data.uploadedPhoto" :alt="slotProps.data.name" class="w-9 shadow-2 my-3 mx-0" />
