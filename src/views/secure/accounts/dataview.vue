...
const { accountss, error, loading,totalpages,page,totalRecords} = storeToRefs(useAccountsStore())
const {  
getAccounts
} = useAccountsStore()
                    ...
                    <template #list="slotProps">
                        <div class="col-12">
                            <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                                <img v-if="slotProps.data.selfyphoto!=undefined" :src="config.serverURI+'/' + slotProps.data.selfyphoto" :alt="slotProps.data.name" class="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <div class="mb-3">{{ slotProps.data.name }}</div>
                        ...
                        <div class="col-12 md:col-4">
                            <div class="card m-3 border-1 surface-border">
                                ...
                                <div class="text-center">
                                    ...
                                    <img v-if="slotProps.data.selfyphoto!=undefined" :src="config.serverURI+'/' + slotProps.data.selfyphoto" :alt="slotProps.data.name" class="w-9 shadow-2 my-3 mx-0" />
                                ...
                                <div class="flex align-items-center justify-content-between">
                                    <span class="text-2xl font-semibold">{{ slotProps.data.walletbalance }}</span>
